          ...
          child: Padding(
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => CartTable(controller: controller)),
                );
              },
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.table_restaurant, color: Colors.green[200]),
                  SizedBox(width: 8.0),
                  Text("ชำระเงิน", style: TextStyle(color: Colors.black)),
                ],
              ),
            ),
          ),
